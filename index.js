...
function updateBrowserPosition(worldPos) {
    ...
    try {
        ...
        // If conversion fails or point is off-screen (behind camera), hide or don't update
        ...
        smoothedScale = smoothedScale + (targetScale - smoothedScale) * 0.3; // Less smoothing for scale
        
        // Update browser with exact position
        browser.active = true;
...
mp.events.add('render', () => {
    ...
    // Update browser position - converts 3D to screen with heavy smoothing
