...
function updateBrowserPosition(worldPos) {
    ...
    try {
        ...
        // Validate screen position - if it's too far off screen, hide it
        // Expanded range slightly to prevent popping at edges
        ...
        // Removed smoothing for scale too to make it instant.
        ...
        const scale = targetScale.toFixed(2);
...
mp.events.add('render', () => {
    ...
    // Update browser position - direct conversion
